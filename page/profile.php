        ...
        <?php echo @$alert; if(@$_GET['proses'] == 'editprofile') : ?>
            <form action="?url=profile&&proses=editprofile" method="post">
                ...
                <div class="input-group mb-4">
                    ...
                    <input type="text" class="form-control" id="alamat"  value="<?= $user['alamat'] ?>" name="alamat" required placeholder="Masukkan Alamat Lengkap">
                </div>
            ...
            <?php elseif (@$_GET['proses'] == 'editpassword') : ?>
                <form action="?url=profile&&proses=editpassword" method="post">
                    <div class="input-group mb-4">
                        <label for="password" class="input-group-text"><i class="fa-solid fa-circle-user fa-fw fa-lg"></i></label>
                ...
                <?php else : ?>
                    <div class="table-responsive">
                        <table class="table table-white table-lover">
                            <tr>
